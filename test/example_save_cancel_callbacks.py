...
class DataManager(QMainWindow):
    ...
    def open_editor(self):
        ...
        if self.editor is None or not self.editor.isVisible():
            sample_data = [
                {'task': 'Design UI', 'assignee': 'Alice', 'status': 'In Progress', 'priority': 'High'},
                {'task': 'API Implementation', 'assignee': 'Bob', 'status': 'In Progress', 'priority': 'High'},
                {'task': 'Testing', 'assignee': 'Charlie', 'status': 'Pending', 'priority': 'Medium'},
                {'task': 'Documentation', 'assignee': 'Diana', 'status': 'Pending', 'priority': 'Low'},
            ]
