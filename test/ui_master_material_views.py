...
class MasterMaterialView(BaseDialogView):
    ...
    def on_edit_clicked(self):
        ...
        if self.router:
            self.router.navigate('/material-edit', {
...
class MasterMaterialEditView(BaseDialogView):
    ...
    def __init__(self, routeData: dict = {}, router: 'Router' = None):
        ...
        self.ui.tableCalculatedParameters = self.tableCalculatedParameters  # Add to ui for compatibility
    ...
    def on_save_clicked(self):
        ...
        if self.router:
            self.router.navigate('/material-view', {
