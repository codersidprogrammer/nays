...
class Ui_MasterMaterialEdit(object):
    def setupUi(self, MasterMaterialEdit):
        if not MasterMaterialEdit.objectName():
            MasterMaterialEdit.setObjectName("MasterMaterialEdit")
        ...
        self.lineEditMaterialID.setObjectName("lineEditMaterialID")
        ...
        self.lineEditMaterialName.setObjectName("lineEditMaterialName")
        ...
        self.tableInputParameters.setObjectName("tableInputParameters")
        ...
        self.tableCalculatedParameters.setObjectName("tableCalculatedParameters")
    ...
    def retranslateUi(self, MasterMaterialEdit):
        MasterMaterialEdit.setWindowTitle(
            QCoreApplication.translate("MasterMaterialEdit", "Dialog", None)
        )
        self.groupBox.setTitle(QCoreApplication.translate("MasterMaterialEdit", "Materials", None))
        self.label_29.setText(QCoreApplication.translate("MasterMaterialEdit", "Material ID", None))
        self.label_30.setText(
            QCoreApplication.translate("MasterMaterialEdit", "Material Name", None)
        )
        self.label.setText(
            QCoreApplication.translate("MasterMaterialEdit", "Input Parameters", None)
        )
        ___qtablewidgetitem = self.tableInputParameters.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("MasterMaterialEdit", "Value", None))
        ___qtablewidgetitem1 = self.tableInputParameters.verticalHeaderItem(0)
        ___qtablewidgetitem1.setText(
            QCoreApplication.translate("MasterMaterialEdit", "Outer Diameter [m]", None)
        )
        ___qtablewidgetitem2 = self.tableInputParameters.verticalHeaderItem(1)
        ___qtablewidgetitem2.setText(
            QCoreApplication.translate("MasterMaterialEdit", "Wet Weight [kg/m]", None)
        )
        ___qtablewidgetitem3 = self.tableInputParameters.verticalHeaderItem(2)
        ___qtablewidgetitem3.setText(
            QCoreApplication.translate("MasterMaterialEdit", "Dry Weight [kg/m]", None)
        )
        ___qtablewidgetitem4 = self.tableInputParameters.verticalHeaderItem(3)
        ___qtablewidgetitem4.setText(
            QCoreApplication.translate("MasterMaterialEdit", "EA [kN]", None)
        )
        ___qtablewidgetitem5 = self.tableInputParameters.verticalHeaderItem(4)
        ___qtablewidgetitem5.setText(
            QCoreApplication.translate("MasterMaterialEdit", "EI [kN.m^2]", None)
        )
        ___qtablewidgetitem6 = self.tableInputParameters.verticalHeaderItem(5)
        ___qtablewidgetitem6.setText(QCoreApplication.translate("MasterMaterialEdit", "Ci", None))
        ___qtablewidgetitem7 = self.tableInputParameters.verticalHeaderItem(6)
        ___qtablewidgetitem7.setText(QCoreApplication.translate("MasterMaterialEdit", "Cd", None))
        ___qtablewidgetitem8 = self.tableInputParameters.verticalHeaderItem(7)
        ___qtablewidgetitem8.setText(
            QCoreApplication.translate("MasterMaterialEdit", "GAS [kg/m]", None)
        )
        ___qtablewidgetitem9 = self.tableInputParameters.verticalHeaderItem(8)
        ___qtablewidgetitem9.setText(
            QCoreApplication.translate("MasterMaterialEdit", "Break Tension [N.m^2]", None)
        )
        self.pbCalculate.setText(
            QCoreApplication.translate("MasterMaterialEdit", "Calculate", None)
        )
        self.label_2.setText(
            QCoreApplication.translate("MasterMaterialEdit", "Calculated Parameters", None)
        )
        ___qtablewidgetitem10 = self.tableCalculatedParameters.horizontalHeaderItem(0)
        ___qtablewidgetitem10.setText(
            QCoreApplication.translate("MasterMaterialEdit", "Value", None)
        )
        ___qtablewidgetitem11 = self.tableCalculatedParameters.verticalHeaderItem(0)
        ___qtablewidgetitem11.setText(
            QCoreApplication.translate("MasterMaterialEdit", "GAE [N]", None)
        )
        ___qtablewidgetitem12 = self.tableCalculatedParameters.verticalHeaderItem(1)
        ___qtablewidgetitem12.setText(
            QCoreApplication.translate("MasterMaterialEdit", "GEI [N.m^2]", None)
        )
        ___qtablewidgetitem13 = self.tableCalculatedParameters.verticalHeaderItem(2)
        ___qtablewidgetitem13.setText(
            QCoreApplication.translate("MasterMaterialEdit", "GRHOL [kg/m]", None)
        )
        ___qtablewidgetitem14 = self.tableCalculatedParameters.verticalHeaderItem(3)
        ___qtablewidgetitem14.setText(
            QCoreApplication.translate("MasterMaterialEdit", "GRHOA [kg/m]", None)
        )
        ___qtablewidgetitem15 = self.tableCalculatedParameters.verticalHeaderItem(4)
        ___qtablewidgetitem15.setText(
            QCoreApplication.translate("MasterMaterialEdit", "GCI [N.m^2]", None)
        )
        ___qtablewidgetitem16 = self.tableCalculatedParameters.verticalHeaderItem(5)
        ___qtablewidgetitem16.setText(
            QCoreApplication.translate("MasterMaterialEdit", "GCD [kg/m]", None)
        )
        ...
        ___qtablewidgetitem18.setText(
            QCoreApplication.translate("MasterMaterialEdit", "BKTEN [N.m^2]", None)
        )
