...
from nays.ui.handler import TableViewHandler, createTableEditor, createTableEditorEmbedded
            ...
            return [
                {
                    ...
                    "type": "combobox",
                    "items": [{1: "Linear"}, {2: "Quadratic"}, {3: "Cubic"}],
                },
                {
                    "name": "IOPT",
                    "description": "Option",
                ...
                {"name": "GLEN", "description": "Length", "type": "text", "defaultValue": "1.0"},
            ]
...
class MyApplication(QMainWindow):
    ...
    def open_element_definition_editor(self):
        ...
        material_segment_data = next((item for item in _data if item.get("name") == "IPOLY"), None)
        ...
        def on_save_handler(callback_data):
            ...
            self.statusBar().showMessage(f"Updated {callback_data['rowCount']} line definitions")
