...
from nays.ui.handler import createTableEditor, TableEditorWidget
...
class TestCreateTableEditor:
    ...
    def test_dark_mode(self, qt_app):
        ...
        assert 'dark' in editor.tableView.styleSheet().lower() or '#0d1117' in editor.tableView.styleSheet()
    ...
    def test_toolbar_visibility(self, qt_app):
        ...
        # Without toolbar
        editor_without = createTableEditor(
            headers=headers,
            data=data,
