...
def example_1_simple_list_of_dicts():
    ...
    data = [
        {'Name': 'Alice Johnson', 'Age': 28, 'Email': 'alice@company.com', 'Department': 'Engineering'},
        ...
        {'Name': 'David Chen', 'Age': 29, 'Email': 'david@company.com', 'Department': 'Engineering'},
    ]
...
def example_6_dark_theme():
    ...
    data = [
        ...
        {'Task': 'Implement backend API', 'Assignee': 'Bob', 'Priority': 'High', 'Completed': False},
        {'Task': 'Write documentation', 'Assignee': 'Carol', 'Priority': 'Medium', 'Completed': True},
