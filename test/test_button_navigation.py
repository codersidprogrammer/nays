...
if __name__ == '__main__':
    ...
    assert isinstance(material_view, MasterMaterialView), f"Expected MasterMaterialView but got {type(material_view)}"
    ...
    assert isinstance(edit_view, MasterMaterialEditView), f"Expected MasterMaterialEditView but got {type(edit_view)}"
    ...
    assert isinstance(material_view_2, MasterMaterialView), f"Expected MasterMaterialView but got {type(material_view_2)}"
    ...
    assert isinstance(entry_view_2, EntryWindowView), f"Expected EntryWindowView but got {type(entry_view_2)}"
