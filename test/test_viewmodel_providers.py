...
from nays import NaysModule, Provider, ModuleFactory, Router, OnInit, RouteType, Route
...
class TestViewModelProvidersSingleton(unittest.TestCase):
    ...
    def test_multiple_viewmodel_providers(self):
        ...
        @NaysModule(
            providers=[user_vm_provider, data_vm_provider]
        )
    ...
    def test_viewmodel_provider_with_routes(self):
        ...
        @NaysModule(
            providers=[user_vm_provider],
            routes=[user_route, user_edit_route]
        )
        class UserModule:
            pass
    ...
    def test_complete_app_scenario_with_viewmodel_providers(self):
        ...
        @NaysModule(
            providers=[data_vm_provider],
            routes=[data_route],
            exports=[DataListViewModel]
        )
        class DataModule:
            pass
