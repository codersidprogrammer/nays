...
def example_simple_with_toolbar():
    ...
    data = [
        {'Name': 'Alice Johnson', 'Email': 'alice@company.com', 'Active': True, 'Department': 'Engineering'},
        {'Name': 'Bob Smith', 'Email': 'bob@company.com', 'Active': False, 'Department': 'Sales'},
        {'Name': 'Carol White', 'Email': 'carol@company.com', 'Active': True, 'Department': 'Marketing'},
    ]
...
def example_combo_and_checkboxes():
    ...
    data = [
        {'Task': 'Design UI mockups', 'Assignee': 'Alice', 'Status': 'In Progress', 'Priority': 'High', 'Completed': True},
        {'Task': 'Implement backend API', 'Assignee': 'Bob', 'Status': 'To Do', 'Priority': 'High', 'Completed': False},
        {'Task': 'Write documentation', 'Assignee': 'Carol', 'Status': 'Done', 'Priority': 'Medium', 'Completed': True},
        {'Task': 'Setup deployment', 'Assignee': 'David', 'Status': 'In Progress', 'Priority': 'Medium', 'Completed': False},
    ]
