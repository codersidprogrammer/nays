...
from core.module import NaysModule, NaysModuleBase, Provider, ModuleFactory
...
class TestModuleScenarioWithImports(unittest.TestCase):
    ...
    def test_hydro_module_with_own_providers(self):
        ...
        hydro_processing_provider = Provider(provide=HydroProcessingService, useClass=HydroProcessingServiceImpl)
    ...
    def test_line_module_with_own_providers(self):
        ...
        line_processing_provider = Provider(provide=LineProcessingService, useClass=LineProcessingServiceImpl)
    ...
    def test_submodule_can_access_root_providers(self):
        ...
        @NaysModule(
            providers=[hydro_data_provider],
            exports=[HydroDataService]
        )
        class HydroDynamicModule:
            pass
        ...
        @NaysModule(
            providers=[line_data_provider],
            exports=[LineDataService]
        )
        class LineModule:
            pass
    ...
    def test_complex_module_hierarchy(self):
        ...
        expected_providers = [
            ...
            HydroDataService, HydroProcessingService,
            LineDataService, LineProcessingService
        ]
