...
from ui_master_material_views import EntryWindowView, MasterMaterialEditView, MasterMaterialView
...
# ==================== Routes ====================
entry_window_route = Route(path="/", component=EntryWindowView, routeType=RouteType.WINDOW)
