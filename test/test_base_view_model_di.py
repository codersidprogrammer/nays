...
from nays import (
    NaysModule, Provider, ModuleFactory, Router,
    OnInit, OnDestroy, RouteType, Route
)
...
class HydroViewModel(BaseTestViewModel):
    ...
    def __init__(self, hydro_service: HydroService, logger: LoggerService, 
...
class LineViewModel(BaseTestViewModel):
    ...
    def __init__(self, line_service: LineService, logger: LoggerService,
                 parent: Optional[QObject] = None):
        super().__init__(logger, parent)
...
class CombinedViewModel(BaseTestViewModel):
    ...
    def __init__(self, hydro_service: HydroService, line_service: LineService,
                 data_service: DataService, logger: LoggerService,
                 parent: Optional[QObject] = None):
        super().__init__(logger, parent)
        self.hydro_service = hydro_service
        self.line_service = line_service
...
class TestViewModelWithRoutes(unittest.TestCase):
    ...
    def test_hydro_view_with_view_model_in_route(self):
        ...
        hydro_route = Route(
            name="hydro_data",
            path="/hydro",
            component=HydroDataView,
            routeType=RouteType.WINDOW
        )
        
        @NaysModule(
            providers=[logger_provider, hydro_provider],
            routes=[hydro_route]
        )
        class HydroModule:
            pass
    ...
    def test_line_view_with_view_model_in_route(self):
        ...
        @NaysModule(
            providers=[logger_provider, line_provider],
            routes=[line_route]
        )
        class LineModule:
            pass
...
class TestCompleteViewModelScenario(unittest.TestCase):
    ...
    def test_complete_module_with_all_view_models(self):
        ...
        @NaysModule(
            providers=[hydro_service_provider],
            exports=[HydroService]
        )
        class HydroModule:
            pass
        ...
        @NaysModule(
            providers=[line_service_provider],
            exports=[LineService]
        )
        class LineModule:
            pass
