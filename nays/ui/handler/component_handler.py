from PySide6.QtCore import QObject, Qt, QTimer, Signal, SignalInstance
...
class TreeHandler(QObject):
    ...
    def addItemTree(
        self, item: QTreeWidgetItem, parent: QTreeWidgetItem = None, allowEmit: bool = True
    ):
...
class ComboboxHandler(QObject):
    ...
    def getComboData(self) -> list[dict]:
        ...
        for index in range(self.combobox.count()):
            ...
            allItems.append({"index": index, "text": text, "data": data})
        return allItems
